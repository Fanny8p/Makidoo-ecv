<div class="gallery js-flickity">
  <div class="gallery-cell <?php if($page == 'profil') echo 'is-active'; ?>">
    <a href="profil.php">
      ...
      <span class="slide-menu__span libre-picto <?php if($page == 'profil') echo 'is-active'; ?>">Profil</span>
    </a>
  </div>
  ...
  <div class="gallery-cell <?php if($page == 'mentions-legales') echo 'is-active'; ?>">
    <a href="#">
      ...
      <span class="slide-menu__span <?php if($page == 'mentions-legales') echo 'is-active'; ?>">Mentions</span>
    </a>
  </div>
